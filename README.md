<h1 align="center"> 🚀 Rust Básico </h1>

## ✍️ Descrição
Exemplificação da sintaxe geral e básica da Linguagem Rust
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-rust.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[REPLIT](https://replit.com/@cleibp/Basic-Rust) 
